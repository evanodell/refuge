...
#' refuge
#'
#' @description [Refuge Restrooms]{https://www.refugerestrooms.org/)
...
#' on the API and the organisation behind it,
#' see the [API docs](https://www.refugerestrooms.org/api/docs/), or the
